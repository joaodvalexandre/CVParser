...
function requireNodeUtils() {
	...
	*/
	function escapeAbruptClosingCommentTag(rawContent) {
		if (rawContent.startsWith(">")) return "&gt;" + rawContent.slice(1);
		if (rawContent.startsWith("->")) return "-&gt;" + rawContent.slice(2);
		return rawContent;
	}
	/**
	...
	*/
	function escapeClosingCommentTag(rawContent) {
		...
		if (!CLOSING_COMMENT_REGEXP.test(content)) return content;
...
function requireElement() {
	...
	if ((_globalThis$Symbol = globalThis.Symbol) === null || _globalThis$Symbol === void 0 ? void 0 : _globalThis$Symbol.iterator) AttributesArray.prototype[globalThis.Symbol.iterator] = function() {
	...
	CSSStyleDeclaration_1 = function(elt) {
		...
		return new Proxy(style, {
			...
			set: function(target, property, value) {
				...
				else target.setProperty(dasherizeProperty(property), value !== null && value !== void 0 ? value : void 0);
				return true;
			}
		});
	};
