...
import { $c as _global, Al as ɵɵdefineInjector, Bc as PLATFORM_ID, Cr as TracingService, Dc as INJECTOR_SCOPE, Dr as ViewEncapsulation, F as createPlatformFactory, Fn as Injectable, Kc as RuntimeError, Ki as setDocument, Nl as ɵɵinject, Nr as allLeavingAnimations, Pn as Inject, Qn as Optional, Rc as NgZone, Sc as ErrorHandler, Tr as USE_PENDING_TASKS, Vc as PLATFORM_INITIALIZER, Wi as setClassMetadata, Xr as describeDomNode, Z as internalCreateApplication, _c as DOCUMENT, ar as RendererFactory2, br as TestabilityRegistry, dc as _asyncToGenerator, gl as makeEnvironmentProviders, hc as CSP_NONCE, hr as TESTABILITY_GETTER, kc as InjectionToken, kl as ɵɵdefineInjectable, mr as TESTABILITY, or as RendererStyleFlags2, ot as platformCore, pc as APP_ID, qn as NgModule, ro as ɵɵdefineNgModule, sr as SHARED_STYLES_HOST, t as ApplicationModule, ul as inject, yr as Testability } from "./core-Dj-lCDLc.js";
import { Bt as DomAdapter, C as CommonModule, Ut as getDOM, Wt as setRootDomAdapter, a as PLATFORM_BROWSER_ID, y as parseCookieValue } from "./common-DLvuWdDG.js";
...
var DomRendererFactory2 = class {
	...
	createRenderer(element, type) {
		...
		if (type.encapsulation === ViewEncapsulation.ShadowDom || type.encapsulation === ViewEncapsulation.ExperimentalIsolatedShadowDom) type = _objectSpread2(_objectSpread2({}, type), {}, { encapsulation: ViewEncapsulation.Emulated });
