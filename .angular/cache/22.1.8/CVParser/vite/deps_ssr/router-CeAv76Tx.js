import { i as init_defineProperty, n as init_objectSpread2, r as _defineProperty, t as _objectSpread2 } from "./objectSpread2-DuxqTrfZ.js";
import { $n as Output, Ac as Injector, Al as ɵɵdefineInjector, Bl as require_cjs, Bt as computed, Cc as EventEmitter, Di as provideAppInitializer, Ea as ɵɵcontentQuery, Ei as performanceMarkFeature, En as ElementRef, Er as ViewContainerRef, Fn as Injectable, In as Input, Jo as ɵɵinvalidFactory, Kc as RuntimeError, Lo as ɵɵinjectAttribute, Mi as publishNonCoreGlobalUtil, Mn as IS_HYDRATION_DOM_REUSE_ENABLED, Mr as afterNextRender, Nl as ɵɵinject, O as booleanAttribute, Oc as INTERNAL_APPLICATION_ERROR_HANDLER, Ps as ɵɵsanitizeUrlOrResourceUrl, Rc as NgZone, Sl as runInInjectionContext, Wc as PendingTasksInternal, Wi as setClassMetadata, Wt as linkedSignal, X as input, Xc as Version, Xo as ɵɵloadQuery, Yn as NgModuleFactory$1, Yo as ɵɵlistener, Yt as APP_BOOTSTRAP_LISTENER, _c as DOCUMENT, a as ContentChildren, al as formatRuntimeError, an as ChangeDetectionStrategy, ao as ɵɵdefineService, bl as provideEnvironmentInitializer, cn as Component, dc as _asyncToGenerator, dr as Service, el as assertInInjectionContext, et as maybeUnwrapDefaultExport, f as HostAttributeToken, fl as isInjectable, fn as Console, ft as reflectComponentType, gl as makeEnvironmentProviders, go as ɵɵelement, il as effect, ir as Renderer2, jn as IS_ENABLED_BLOCKING_INITIAL_NAVIGATION, kc as InjectionToken, kl as ɵɵdefineInjectable, kn as HostListener, la as ɵɵNgOnChangesFeature, lc as require_operators, ml as isStandalone, nn as Attribute, no as ɵɵdefineDirective, on as Compiler, oo as ɵɵdirectiveInject, pt as resourceFromSnapshots, qn as NgModule, qr as createEnvironmentInjector, qt as untracked, r as ChangeDetectorRef, ro as ɵɵdefineNgModule, tn as ApplicationRef, to as ɵɵdefineComponent, ul as inject, vc as DestroyRef, vi as isNgModule, vl as promiseWithResolvers, vs as ɵɵqueryRefresh, wl as signal, wn as Directive, xc as EnvironmentInjector, ya as ɵɵattribute, yc as ENVIRONMENT_INITIALIZER, yi as isPromise } from "./core-Dj-lCDLc.js";
import { Ht as PlatformLocation, It as PathLocationStrategy, Nt as Location, Pt as LocationStrategy, Vt as LOCATION_INITIALIZED, b as PRECOMMIT_HANDLER_SUPPORTED, j as HashLocationStrategy, l as ViewportScroller, n as NavigationAdapterForLocation, x as PlatformNavigation } from "./common-DLvuWdDG.js";
import { s as Title } from "./platform-browser-C8T4CzVk.js";
...
var ActivatedRoute = class {
	constructor(urlSubject, paramsSubject, queryParamsSubject, fragmentSubject, dataSubject, outlet, component, futureSnapshot) {
		...
		this.title = (_this$dataSubject$pip = (_this$dataSubject = this.dataSubject) === null || _this$dataSubject === void 0 ? void 0 : _this$dataSubject.pipe((0, import_operators.map)((d) => d[RouteTitleKey]))) !== null && _this$dataSubject$pip !== void 0 ? _this$dataSubject$pip : (0, import_cjs.of)(void 0);
		this.url = urlSubject;
	...
	get paramMap() {
		var _this$_paramMap;
		(_this$_paramMap = this._paramMap) !== null && _this$_paramMap !== void 0 || (this._paramMap = this.params.pipe((0, import_operators.map)((p) => convertToParamMap(p))));
		return this._paramMap;
	}
	get queryParamMap() {
		var _this$_queryParamMap2;
		(_this$_queryParamMap2 = this._queryParamMap) !== null && _this$_queryParamMap2 !== void 0 || (this._queryParamMap = this.queryParams.pipe((0, import_operators.map)((p) => convertToParamMap(p))));
		return this._queryParamMap;
	}
	toString() {
...
function isEmptyError(e) {
	return e instanceof import_cjs.EmptyError || (e === null || e === void 0 ? void 0 : e.name) === "EmptyError";
}
...
function checkGuards(forwardEvent) {
	return (0, import_operators.mergeMap)((t) => {
		...
		if (canDeactivateChecks.length === 0 && canActivateChecks.length === 0) return (0, import_cjs.of)(_objectSpread2(_objectSpread2({}, t), {}, { guardsResult: true }));
		...
		}), (0, import_operators.map)((guardsResult) => _objectSpread2(_objectSpread2({}, t), {}, { guardsResult })));
	});
}
...
function matchWithChecks(segmentGroup, route, segments, injector, urlSerializer, createSnapshot, abortSignal) {
	...
	return runCanMatchGuards(injector, route, segments, urlSerializer, currentSnapshot, abortSignal).pipe((0, import_operators.map)((v) => v === true ? result : _objectSpread2({}, noMatch)));
}
...
function recognize(injector, configLoader, rootComponentType, config, serializer, paramsInheritanceStrategy, abortSignal) {
	return (0, import_operators.mergeMap)(function() {
...
var NavigationTransitions = class {
	...
	constructor() {
		...
		_defineProperty(this, "events", new import_cjs.Subject());
		_defineProperty(this, "transitionAbortWithErrorSubject", new import_cjs.Subject());
		...
		_defineProperty(this, "afterPreactivation", () => (0, import_cjs.of)(void 0));
		...
		return this.transitions.pipe((0, import_operators.filter)((t) => t !== null), (0, import_operators.switchMap)((overallTransitionState) => {
			...
			return (0, import_cjs.of)(overallTransitionState).pipe((0, import_operators.switchMap)((t) => {
				...
				if (this.urlHandlingStrategy.shouldProcessUrl(t.rawUrl)) return (0, import_cjs.of)(t).pipe((0, import_operators.switchMap)((t) => {
					...
					return (0, import_cjs.from)((_overallTransitionSta = overallTransitionState.routesRecognizeHandler.deferredHandle) !== null && _overallTransitionSta !== void 0 ? _overallTransitionSta : (0, import_cjs.of)(void 0)).pipe((0, import_operators.map)(() => value));
			...
			}), (_this$routerResources = (_this$routerResources2 = this.routerResourcesFeature) === null || _this$routerResources2 === void 0 ? void 0 : _this$routerResources2.setupAndRunResources(abortController.signal)) !== null && _this$routerResources !== void 0 ? _this$routerResources : ((t) => t), switchTap(() => this.afterPreactivation()), (0, import_operators.switchMap)(() => {
...
var Router = class {
	...
	constructor() {
		...
		_defineProperty(this, "_events", new import_cjs.Subject());
		...
		_defineProperty(this, "eventsSubscription", new import_cjs.Subscription());
...
var RouterLink = class {
	...
	constructor(router, route, tabIndexAttribute, renderer, el, locationStrategy) {
		...
		_defineProperty(this, "onChanges", new import_cjs.Subject());
...
var NavigationStateManager = class extends StateManager {
	...
	constructor() {
		...
		_defineProperty(this, "nonRouterCurrentEntryChangeSubject", new import_cjs.Subject());
