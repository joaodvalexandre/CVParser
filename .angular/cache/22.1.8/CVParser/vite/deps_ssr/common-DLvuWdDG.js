...
import { $i as unwrapSafeValue, $r as findLocaleData, Ac as Injector, Al as ɵɵdefineInjector, Bl as require_cjs, Bn as LOCALE_ID, Dn as Host, Ei as performanceMarkFeature, El as stringify, En as ElementRef, Er as ViewContainerRef, Fn as Injectable, In as Input, Jr as createNgModule, Kc as RuntimeError, Lo as ɵɵinjectAttribute, Nl as ɵɵinject, O as booleanAttribute, Oc as INTERNAL_APPLICATION_ERROR_HANDLER, Oo as ɵɵgetInheritedFactory, Pi as registerLocaleData$1, Pn as Inject, Qn as Optional, Rc as NgZone, Tc as IMAGE_CONFIG_DEFAULTS, Vn as LocaleDataIndex, Wi as setClassMetadata, Xc as Version, Zn as NgModuleRef$1, _c as DOCUMENT, al as formatRuntimeError, ao as ɵɵdefineService, bi as isSubscribable, di as getLocaleCurrencyCode$1, dr as Service, er as Pipe, fi as getLocalePluralCase$1, io as ɵɵdefinePipe, ir as Renderer2, kc as InjectionToken, kl as ɵɵdefineInjectable, la as ɵɵNgOnChangesFeature, m as KeyValueDiffers, mn as DEFAULT_CURRENCY_CODE, nn as Attribute, no as ɵɵdefineDirective, oo as ɵɵdirectiveInject, or as RendererStyleFlags2, p as IterableDiffers, pl as isSignal, qn as NgModule, qt as untracked, r as ChangeDetectorRef, ro as ɵɵdefineNgModule, rt as numberAttribute, ul as inject, vc as DestroyRef, vr as TemplateRef, wc as IMAGE_CONFIG, wn as Directive, yi as isPromise, zs as ɵɵstyleProp } from "./core-Dj-lCDLc.js";
...
var Location = class Location {
	constructor(locationStrategy) {
		_defineProperty(this, "_subject", new import_cjs.Subject());
...
var NgOptimizedImage = class {
	...
	ngOnChanges(changes) {
		...
		if (ngDevMode && ((_changes$placeholder = changes["placeholder"]) === null || _changes$placeholder === void 0 ? void 0 : _changes$placeholder.currentValue) && false);
	}
	getAspectRatio() {
